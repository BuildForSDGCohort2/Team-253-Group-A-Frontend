...
export default function Privacy() {
  ...
  return (
    <div className={classes.root}>
      <Paper>
        <h1>Privacy Policy for CleanOut</h1>

        <p>
          At CleanOut, accessible from awesome-jang-7f1fc2.netlify.app, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that are collected and
          recorded by CleanOut and how we use it.
        </p>
        ...
        <p>
          ...
          CleanOut. This policy is not applicable to any information collected
