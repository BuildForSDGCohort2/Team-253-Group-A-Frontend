    ...
    <div className={classes.root}>
      <Paper>
        ...
        <p>
          ...
          CleanOut’s Website, even if CleanOut or an authorized representative
        ...
        <p>
          ...
          current. CleanOut may change the materials contained on its Website at
          any time without notice. CleanOut does not make any commitment to
        ...
        <p>
          CleanOut has not reviewed all of the sites linked to its Website and
          is not responsible for the contents of any such linked site. The
          presence of any link does not imply endorsement by CleanOut of the
